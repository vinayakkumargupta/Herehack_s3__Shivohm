...
public class RoutingExample1 {
    ...
    private static final String TAG = RoutingExample1.class.getName();
    ...
    public RoutingExample1(Context context, MapView mapView) {
        this.context = context;
        this.mapView = mapView;
        MapCamera camera = mapView.getCamera();
        double distanceInMeters = 1000 * 10;
        MapMeasure mapMeasureZoom = new MapMeasure(MapMeasure.Kind.DISTANCE, distanceInMeters);
        camera.lookAt(new GeoCoordinates(28.4506, 77.5842), mapMeasureZoom);
    ...
    public void addRoute() {
        startGeoCoordinates = createRandomGeoCoordinatesAroundMapCenter1();
    ...
    private GeoCoordinates createRandomGeoCoordinatesAroundMapCenter1() {

        return new GeoCoordinates(28.4711223,77.5937077);
    }

    private GeoCoordinates createRandomGeoCoordinatesAroundMapCenter() {

        return new GeoCoordinates(28.4506, 77.5842);
    }
