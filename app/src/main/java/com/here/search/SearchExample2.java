...
public class SearchExample2 {
    ...
    private static final String LOG_TAG = SearchExample2.class.getName();
    ...
    public SearchExample2(Context context, MapView mapView) {
        this.context = context;
        this.mapView = mapView;
        camera = mapView.getCamera();
        double distanceInMeters = 1000 * 10;
        MapMeasure mapMeasureZoom = new MapMeasure(MapMeasure.Kind.DISTANCE, distanceInMeters);
        camera.lookAt(new GeoCoordinates(28.4506512,77.5820091), mapMeasureZoom);
...
//        Toast.makeText(context,"Long press on map to get the address for that position using reverse geocoding.", Toast.LENGTH_LONG).show();
    ...
    private void searchExample() {
        String searchTerm = "Fire station";
...
//        Toast.makeText(context,"Searching in viewport: " + searchTerm, Toast.LENGTH_LONG).show();
    ...
    private void geocodeAnAddress() {
        ...
        GeoCoordinates geoCoordinates = new GeoCoordinates(28.4506512,77.5820091);
        double distanceInMeters = 1000 * 7;
        MapMeasure mapMeasureZoom = new MapMeasure(MapMeasure.Kind.DISTANCE, distanceInMeters);
        camera.lookAt(geoCoordinates, mapMeasureZoom);

        String queryString = "Bennett University Greater Noida";
